...
public class CsrfGateFilterTest {
  ...
  @Mock private ICsrfProtectionDefinitionProvider csrfProtectionDefinitionProvider;
  ...
  public void testInitWithCsrfProtectionDisabled() throws Exception {
    ...
    verify( csrfProtectionDefinitionProvider ).addListener( any( ICsrfProtectionDefinitionListener.class ) );
  }
  ...
  public void testPluginManagerReload() throws Exception {
    ...
    // Setup
    ArgumentCaptor<ICsrfProtectionDefinitionListener> listenerCapture =
      ArgumentCaptor.forClass( ICsrfProtectionDefinitionListener.class );
    ...
    listenerCapture.getValue().onDefinitionsChanged();
