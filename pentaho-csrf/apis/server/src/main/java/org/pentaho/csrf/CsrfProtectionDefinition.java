...
/**
 * This class represents an extension to the contract of a plugin containing CSRF protection information.
 */
public class CsrfProtectionDefinition {
   ...
   *
   * @param protectedRequestMatchers the request matchers.
   */
  public void setProtectedRequestMatchers( Collection<RequestMatcherDefinition> protectedRequestMatchers ) {
    this.protectedRequestMatchers = protectedRequestMatchers;
  }
}
