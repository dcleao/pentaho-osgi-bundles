...
package org.pentaho.csrf.client;
...
public interface ICsrfClient {
   ...
   */
  ICsrfToken getToken( URI tokenServiceUri, CookieHandler cookieHandler, URI protectedServiceUri );
}
