...
public class CsrfGateFilterTest {
  ...
  @Mock private CsrfConfigurationProvider csrfConfigProvider;
  ...
  private CsrfConfiguration getNonEmptyCsrfConfiguration() {
  ...
  public void testInitWithCsrfProtectionDisabled() throws Exception {
    ...
    when( csrfConfigProvider.getCsrfConfiguration() ).thenReturn( new CsrfConfiguration() );
    ...
    verify( csrfConfigProvider ).addCsrfConfigurationListener( any( Runnable.class ) );
  }
  ...
  public void testCsrfConfigurationChangeCausesReload() throws Exception {
    ...
    doNothing().when( csrfConfigProvider ).addCsrfConfigurationListener( listenerCapture.capture() );
