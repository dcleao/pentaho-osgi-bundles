...
public class CsrfGateFilter implements Filter {
  ...
  private CsrfConfigurationProvider csrfProtectionDefinitionProvider;

  public CsrfGateFilter( CsrfTokenRepository csrfTokenRepository, CsrfConfigurationProvider csrfProtectionDefinitionProvider ) {
  ...
  public void init( FilterConfig filterConfig ) throws ServletException {
    ...
    this.csrfProtectionDefinitionProvider.addCsrfConfigurationListener( () -> {
  ...
  private synchronized void doInit() {
    ...
    Collection<CsrfConfiguration> csrfConfigurations =
      this.csrfProtectionDefinitionProvider.getProtectionDefinitions();

    boolean isCsrfProtectionEnabled = csrfConfigurations != null && csrfConfigurations.size() > 0;
    if ( isCsrfProtectionEnabled ) {
      RequestMatcher requestMatcher = CsrfUtil.buildCsrfRequestMatcher( csrfConfigurations );
